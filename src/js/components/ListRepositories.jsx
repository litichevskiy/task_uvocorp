...
class ListRepositories extends Component {
    ...
    constructor( props ) {
        ...
        this.state = {
            listRepos: store.repositoriesList,
                ...
                <ul className="list">
                    {
                        state.listRepos.map( ( item, index ) => {
                            descriptionClassName = ( item.description ) ? 'description' : 'hide';
                            return(
                                <li key={index} className="itemList">
                                    ...
                                    <div className="blockInfo">
                                        <div className="cellInfo">
                                            <svg className="svgIcon" height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="cellInfo">
                                            <svg className="svgIcon" height="18" viewBox="0 0 24 24" width="18" xmlns="http://www.w3.org/2000/svg">
